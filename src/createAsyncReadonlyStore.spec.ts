...
import { createAsyncReadonlyStore, initializeAsyncReadonlyStore } from '.';

test('calling initializeAsyncReadonlyStore() with no createAsyncReadonlyStore() call does nothing', () => {
  initializeAsyncReadonlyStore('unknown-module')
})
