...
it('calling initializeAsyncStore() with no createAsyncStore() call does nothing', () => {
	initializeAsyncStore('unknown-module')
})

it('init single store with key', async () => {
...
it('init single store without key', async () => {
...
it('init multiple createAsyncStore calls with key', async () => {
...
it('init multiple stores in the same module without key', async () => {
...
it('init stores with different numeric versions is ordered by version', async () => {
...
it('init stores with different string versions is ordered by version', async () => {
...
it('number version is compared to the patch value of string version', async () => {
